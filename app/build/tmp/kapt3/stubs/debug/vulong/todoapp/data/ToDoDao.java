...
public abstract interface ToDoDao {
    ...
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<vulong.todoapp.data.models.ToDoTask>> getByLowPriority();
    ...
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<vulong.todoapp.data.models.ToDoTask>> getByHighPriority();
    
    @org.jetbrains.annotations.NotNull()
    @androidx.room.Query(value = "SELECT * FROM todo_table WHERE title LIKE :searchQuery OR description LIKE :searchQuery")
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<vulong.todoapp.data.models.ToDoTask>> searchTasks(@org.jetbrains.annotations.NotNull()
